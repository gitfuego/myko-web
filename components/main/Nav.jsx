    ...
    <nav className={styles.mainContainer}>
      <div className={styles.iconContainer}>
        ...
        <button type='button' className={tab === 'profile' ? 'active' : ''} onClick={() => changeTab('profile')}>
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M20.907 21.9517V19.861C20.907 18.7521 20.4664 17.6885 19.6823 16.9044C18.8981 16.1202 17.8346 15.6797 16.7256 15.6797H8.36297C7.25402 15.6797 6.19048 16.1202 5.40632 16.9044C4.62217 17.6885 4.18164 18.7521 4.18164 19.861V21.9517" stroke="#CECECE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M12.5446 11.4994C14.8539 11.4994 16.7259 9.62734 16.7259 7.31805C16.7259 5.00877 14.8539 3.13672 12.5446 3.13672C10.2353 3.13672 8.36328 5.00877 8.36328 7.31805C8.36328 9.62734 10.2353 11.4994 12.5446 11.4994Z" stroke="#CECECE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </button>
      </div>
      <style jsx>{`
